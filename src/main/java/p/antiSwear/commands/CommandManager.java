...
import p.antiSwear.commands.subcommands.AddWordSubCommand;
import p.antiSwear.commands.subcommands.ReloadSubCommand;
import p.antiSwear.commands.subcommands.RemoveWordSubCommand;
...
public class CommandManager implements CommandExecutor, TabCompleter {
    ...
    public CommandManager(AntiSwear plugin) {
        this.plugin = plugin;
        registerSubCommands();
    }
